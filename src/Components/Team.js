    ...
    <div className="bg-gray-50   py-12">
      ...
      <h2 className=" text-4xl text-start text-gray-800 mb-1">
        ...
        <h2 className="text-4xl  thin text-center text-gray-800 mb-8">
          ...
          <p className="text-justify p-lg-4 p-3 border bg-slate-100">Our counselors have a Master's Degree in Mental Health Counseling and are licensed by Virginia to perform empirically validated medical counseling.</p>   
