        ...
        <>
          ...
          <div className="bg-slate-50 pt-3">
            <div className="container mb-5">
              <div className="mb-5 ">
              <h2 className="mb-3 process-header barlow green">OUR PROCESS, <span className="text-gray-600 "> BUILT FOR YOU</span> </h2>
              <p className="text-justify text-gray-600 border-top-bottom  process-body text-md pt-4">
                Every service member’s journey is different, and so are their mental health needs. Whether you're facing the weight of deployment, adjusting to life changes, or navigating military-specific challenges, our expert clinicians provide care that fits you—personalized, specialized, and mission-ready.
              </p>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 justify-center">
                {[
                  { icon: "fa-user-circle", title: "Personalized", text: "You are matched with a therapist that fits your needs and style. We take the time to get to know you to make the right pairing." },
                  { icon: "fa-layer-group", title: "Varied", text: "We have a large variety of clinician specialties to take care of your needs, including trauma, suicidal ideations, major depression, anxiety, anger, OCD, and perinatal concerns." },
                  { icon: "fa-flag", title: "Specialized", text: "As most of our clients are on active duty, we specialize in military-specific concerns, including PCS issues, deployments, and transitioning to civilian life." },
                  { icon: "fa-file-alt", title: "Prepared", text: "Our owner, Dr. Lemich, is well-versed in military and VA paperwork, assisting with LIMDU, Med Board, VA, and Security Clearance paperwork if medically necessary." }
                ].map((feature, index) => (
                  <div key={index} className="text-center p-3 border rounded mb-lg-3 ">
