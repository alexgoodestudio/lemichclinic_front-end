    ...
    <div className="container-fluid  position-relative tricare-section">
      <div className="row p-4 bg-tricare1 border3  position-relative py-5">
        ...
        <div className="col-lg-6 py-5  my-lg-5">
          ...
          >
            <p className="m-0 group-hover:text-slate-200 transition-colors duration-300 ">Learn More</p>
            <span className="material-symbols-outlined text-xl transform transition-all duration-300 group-hover:translate-x-1 group-hover:text-slate-100">
              east
            </span>
          </Link>
        </div>
